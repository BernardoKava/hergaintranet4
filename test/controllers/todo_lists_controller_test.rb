...
class TodoListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_list" do
    assert_difference('TodoList.count') do
      post todo_lists_url, params: { todo_list: { active: @todo_list.active, description: @todo_list.description, name: @todo_list.name, todo_item_id: @todo_list.todo_item_id, user_id: @todo_list.user_id } }
    end
  ...
  test "should update todo_list" do
    patch todo_list_url(@todo_list), params: { todo_list: { active: @todo_list.active, description: @todo_list.description, name: @todo_list.name, todo_item_id: @todo_list.todo_item_id, user_id: @todo_list.user_id } }
