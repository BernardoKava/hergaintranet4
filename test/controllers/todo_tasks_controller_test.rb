...
class TodoTasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_task" do
    assert_difference('TodoTask.count') do
      post todo_tasks_url, params: { todo_task: { complete: @todo_task.complete, completed_at: @todo_task.completed_at, name: @todo_task.name, todo_list_id: @todo_task.todo_list_id } }
    end
  ...
  test "should update todo_task" do
    patch todo_task_url(@todo_task), params: { todo_task: { complete: @todo_task.complete, completed_at: @todo_task.completed_at, name: @todo_task.name, todo_list_id: @todo_task.todo_list_id } }
